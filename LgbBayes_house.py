...
def main():
    ...
    file_path = './houseMamba_part0_pred.csv'
    file_path2 = './houseMamba_part1_pred.csv'

    dfdb0 = pd.read_csv(file_path)
    dfdb1 = pd.read_csv(file_path2)

    dfdb = pd.concat([dfdb0, dfdb1], axis=0)
    ...
    lgs = LgbBayes()
    #dfdb.to_csv('./example/data/inHouse/ssssssss.csv', index=None)
    ...
    data_set = lgs.fit_tranform(data=dfdb,
                                ...
                                protein_column=protein_column)
    #data_set.to_csv('./example/data/inHouse/ssssssss2222.csv', index=None)

    # region 
    feature_imp = lgs.feature_imp
    feature_imp.to_csv('./outputData/inhouse/feature_imp.csv', index=None)
    lgs.Feature_imp_plot()
    plt.savefig('./outputData/inhouse/figure/Feature_imp.pdf')
    lgs.CVROC()
    plt.savefig('./outputData/inhouse/figure/DeepSCP_ROC.pdf')
    lgs.PSM_accept()
    plt.savefig('./outputData/inhouse/figure/PSM_accept.pdf')
    # endregion
    ...
    data_set.to_csv('./outputData/inhouse/DeepSCP_evidence.txt', sep='\t', index=False)
    data.to_csv('./outputData/inhouse/DeepSCP_evidence_filter.txt', sep='\t', index=False)

    df_pro.to_csv('./outputData/inhouse/DeepSCP_pro.csv')
    df_pep.to_csv('./outputData/inhouse/DeepSCP_pep.csv', index=False)
    #endregion
    data.to_csv('./outputData/inhouse/data_.csv', index=None)
    #data_set.to_csv('./example/data/inHouse/data_set_.csv', index=None)
    data_set.to_csv('./outputData/inhouse/data_set_.csv', index=None)
    ...
    an_cols['Type'] = 'Empty'
    an_cols.loc[an_cols.Channel == 'Reporter intensity corrected 16', 'Type'] = 'Boost'
    an_cols.loc[an_cols.Channel == 'Reporter intensity corrected 14', 'Type'] = 'unused'
    # region GC
    # region intensity 1
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set37', 'Set39', 'Set47', 'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 1'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set38', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45', 'Set46'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 1'), 'Type'] = 'GC2'
    # endregion

    # region intensity 2
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set37', 'Set38', 'Set46', 'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 2'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set39', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45', 'Set47'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 2'), 'Type'] = 'GC2'
    # endregion

    # region intensity 3
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set38', 'Set39', 'Set47'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 3'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set37', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45', 'Set46',
         'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 3'), 'Type'] = 'GC2'
    # endregion

    # region intensity 4
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set37', 'Set39', 'Set46', 'Set47',
         'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 4'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set38', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 4'), 'Type'] = 'GC2'
    # endregion

    # region intensity 5
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set37', 'Set38', 'Set47'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 5'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set39', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45', 'Set46',
         'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 5'), 'Type'] = 'GC2'
    # endregion

    # region intensity 6
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set38', 'Set39', 'Set46', 'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 6'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set37', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45', 'Set47'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 6'), 'Type'] = 'GC2'
    # endregion
    ...
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set37', 'Set39', 'Set46', 'Set47',
         'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 7'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set38', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 7'), 'Type'] = 'GC2'
    # endregion

    # region intensity 8
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set37', 'Set38', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45',
         'Set46', 'Set47', 'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 8'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set39'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 8'), 'Type'] = 'GC2'
    ...
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set38', 'Set39', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 9'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set37', 'Set46', 'Set47', 'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 9'), 'Type'] = 'GC2'
    ...
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set37', 'Set39', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45',
         'Set46', 'Set47', 'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 10'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set38'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 10'), 'Type'] = 'GC2'
    ...
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set37', 'Set38', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45',
         'Set47', 'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 11'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set39', 'Set46'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 11'), 'Type'] = 'GC2'
    ...
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set39', 'Set38', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45',
         'Set46', 'Set47'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 12'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set37', 'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 12'), 'Type'] = 'GC2'
    ...
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set37', 'Set38', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45',
         'Set46', 'Set47', 'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 13'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set39'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 13'), 'Type'] = 'GC2'
    ...
    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set6', 'Set7', 'Set15', 'Set16', 'Set17', 'Set18', 'Set20', 'Set25', 'Set26', 'Set27', 'Set28',
         'Set33', 'Set34', 'Set35', 'Set36', 'Set37', 'Set38', 'Set40', 'Set41', 'Set42', 'Set43', 'Set44', 'Set45',
         'Set46'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 15'), 'Type'] = 'GC1'

    an_cols.loc[(an_cols['Cleanset'].isin(
        ['Set1', 'Set2', 'Set3', 'Set4', 'Set5', 'Set8', 'Set9', 'Set10', 'Set11', 'Set12', 'Set13', 'Set14', 'Set19',
         'Set21', 'Set22', 'Set23', 'Set24', 'Set29', 'Set30', 'Set31', 'Set32', 'Set39', 'Set47', 'Set48'])) &
                (an_cols['Channel'] == 'Reporter intensity corrected 15'), 'Type'] = 'GC2'

    # endregion
    # endregion

    an_cols.to_csv('./outputData/inhouse/an_cols.csv', index=False)
    an_cols1 = an_cols[(an_cols.Type.isin(['GC1', 'GC2']))]
    ...
    df_pro_ft.to_csv('./outputData/inhouse/pro_ft.csv')
    df_pep_ft.to_csv('./outputData/inhouse/pep_ft.csv')
    #endregion
